  ...
  return (
    <div className="fixed z-20 inset-0 bg-gray-800 bg-opacity-50 p-5 overflow-y-auto h-full w-full flex justify-center items-center">
      ...
      >
        ...
        {/* <button className="bg-gray-200 py-2 rounded-md  ">Completed</button>
        <button className="bg-gray-200 py-2 rounded-md  ">Ongoing</button>
        <button className="bg-gray-200 py-2 rounded-md  ">Pending</button> */}
      </div>
    </div>
  );
};
