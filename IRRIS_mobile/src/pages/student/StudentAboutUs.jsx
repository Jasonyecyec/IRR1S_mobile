      ...
      <div className="h-[90vh]  overflow-y-auto pt-5 pb-5">
        <div>
          <div className="flex justify-center items-center mt-5 pt-5">
            <div class="w-[95%] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div className="satisfactory-container bg-blue-200 h-[10rem]">
                <div className="flex justify-center items-center">
                  <span className="text-2xl text-white rounded-[2.5rem] bg-blue-900 w-[15rem] h-[3.5rem] mt-[-1rem] flex justify-center items-center">System Evaluation</span>
                </div>
                ...
                <div className="bg-blue-300 flex flex-col items-center rounded-[2.5rem] justify-center h-full">
                  <p class="text-2xl text-gray-900 dark:text-white">Rate Us</p>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="w-[95%] h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-[10rem]">
            <ul
...
<div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <div class="flex items-center justify-between mb-4">
        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Admins and Staffs</h5>
