...
export const getRewardsCertificateStudent = async () => {
  try {
    const response = await api.get("/rewards-certificate-student");

    console.log("Fetch rewards-certificate-student response:", response);
    return response.data;
  } catch (error) {
    console.error(
      "Fetch rewards-certificate-student error:",
      error.response || error.message
    );
    throw error;
  }
...
export const getRewardsCouponStudent = async () => {
  try {
    const response = await api.get("/all-coupon-reward");

    console.log("Fetch all-coupon-reward response:", response);
    return response.data;
  } catch (error) {
    console.error(
      "Fetchall-coupon-reward error:",
      error.response || error.message
    );
    throw error;
  }
...
export const uploadProfileImage = async (form) => {
  try {
    ...
    console.error(
      "Fetch upload-profile-image error:",
      error.response || error.message
    );
    throw error;
  }
...
export const forgotPassword2 = async ({
  email,
  newPassword,
  confirmPassword,
}) => {
